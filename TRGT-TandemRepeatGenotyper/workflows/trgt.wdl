...
workflow trgt {
	...
	meta {
		...
		description: <<<
			...
			Docker images containing the tools used by this \workflow can be explored <a href="url">https://github.com/dnastack/bioinformatics-public-docker-images in DNAstack%27's image repository</a>, or [on Dockerhub](https://hub.docker.com/u/dnastack).
